...
<div class="content">
    ...
    <div class="content-body">
        <div class="_header">
            <h1 style="display: inline !important;"><a href ="./orders-manage.php">Sản phẩm</a></h1>
            <h3 style="display: inline !important;">/Tạo sản phẩm mới</h3>
        </div>
        <div class="_show" style="border: none !important;">
            <?php
                include('../../../controller/admin/create/form-create-product.php');
            ?>
        </div>
        <div class="_footer">
